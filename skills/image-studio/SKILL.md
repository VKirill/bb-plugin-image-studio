---
name: image-studio
description: Generate or edit images for the current BB project through Image Studio (fal.ai / kie.ai, Nano Banana 2, Nano Banana Pro, Muse Image, optional GPT Image 1.5, people profiles). Use when the user asks to generate a picture, photo, poster, or a scene with a named person from Image Studio profiles.
---
